...
|---|---|---|---|
| M0 | Hello Vulkan — triangle on screen | RHI init, swapchain, pipeline compiles, runs on Pi4 | ⬜ Scaffold ready, implementation not started |
...
| M4 | Hello Physics — cube falls and stops | Jolt↔JobSystem adapter, barriers respected, fixed timestep | ⬜ |
