...
> Questo documento condensa `01-progettazione-engine-3d-rpi.md`, `02-analisi-mvp-roadmap.md` e `03-analisi-tecnica-claude-code.md`. È pensato per essere tenuto come riferimento costante durante lo sviluppo (può essere usato come `CLAUDE.md` nella root del repository). Per il "perché" dietro ogni scelta, i tre documenti completi restano la fonte di verità.
...
- **Lingua: SEMPRE inglese** — codice, commenti, log, messaggi di errore, testo Editor. Nessuna eccezione. (Solo i documenti di progettazione/analisi restano in italiano.)
...
|---|---|---|---|
| M0 | Hello Vulkan — triangolo a schermo | RHI init, swapchain, pipeline compila, gira su Pi4 | ⬜ Da iniziare |
...
- **Perché** ogni scelta architetturale (hardware, rendering TBDR, fisica, audio, input, Editor/Script System, Asset Pipeline, Prefab): `01-progettazione-engine-3d-rpi.md`
- **Roadmap completa** e cosa è escluso dal vertical slice: `02-analisi-mvp-roadmap.md`
- **File/classi esatti** da creare per ogni milestone, motivazione dipendenze: `03-analisi-tecnica-claude-code.md`
