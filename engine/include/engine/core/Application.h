...
// Update + Render phase; M3 adds a Script phase, M4 adds Physics and its barriers, M5
// wires the full sequence from CLAUDE.md section 4:
...
public:
    struct Callbacks {
        // Called once per frame after input has been polled, before rendering.
